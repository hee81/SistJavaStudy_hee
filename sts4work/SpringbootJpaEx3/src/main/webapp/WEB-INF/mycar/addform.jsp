	...
	<form action="insert" method="post">
		<table class="table table-bordered" style="width: 500px;">
			...
			<tr>
				...
				<td><input type="date" name="guipday" class="form-control" style="width: 250px;" required></td>
			</tr>
			<tr>
				<td colspan="2" align="center"><button type="submit" class="btn btn-outline-success btn-lg">DB저장</button></td>
			</tr>
		</table>
	</form>
