...
<body>
	<form action="update" method="post">
		<table class="table table-bordered" style="width: 500px;">
			...
			<tr>
				<th class="table-info">상품가격</th>
				<td><input type="text" name="carprice" class="form-control" style="width: 150px;" value="${dto.carprice }"></td>
			</tr>
			<tr>
				<th class="table-info">상품입고일</th>
				<td><input type="date" name="guipday" class="form-control" style="width: 250px;" value="${dto.guipday }"></td>
			</tr>
			<tr>
				<td colspan="2" align="center"><button type="submit" class="btn btn-outline-success btn-lg">DB수정</button></td>
			</tr>
		</table>
	</form>
